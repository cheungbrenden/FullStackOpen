...
describe('most likes', () => {
  ...
  test('when list has only one blog, choose that one blog', () => {
  ...
  test('find the blog with the highest number of likes', () => {
...
describe('most blogs', () => {
  ...
  test('when list has only one blog, choose that author', () => {
